...
namespace BizLogic
{
    public class GoogleMapHelper
    {
        ...
        public String getAddrByLatandLng(string info)
        {
            ...
            var requestUri = string.Format("https://maps.googleapis.com/maps/api/geocode/xml?latlng={0}&key=AIzaSyBO2qhZdQnzPwjEUbD5UWdyB6zKp_8tWCI", info);
        ...
        {
            var requestUri = string.Format("https://maps.googleapis.com/maps/api/directions/xml?origin={0}&destination={1}&key=AIzaSyBO2qhZdQnzPwjEUbD5UWdyB6zKp_8tWCI", addr1, addr2);
